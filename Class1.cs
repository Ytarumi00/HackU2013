...
public class opencvsharp_test
{
	...
	{
		testImage = Cv.LoadImage("image.jpg");
	}
...
class Form1 : Form
{
	...
	private System.Windows.Forms.PictureBox FaceBefore;
	private System.Windows.Forms.PictureBox FaceAfter;
...
//	private Effect MyEffect;
	...
	private void InitializeComponent(Size W_size)
	{
		...
		this.FaceBefore = new System.Windows.Forms.PictureBox();
		this.FaceAfter = new System.Windows.Forms.PictureBox();
		this.picture = new opencvsharp_test();
		//        this.MyEffect = new Effect(picture.testImage);

		FaceBefore.Location = new Point(0, 0);
		FaceBefore.Image = picture.testImage.ToBitmap();
		FaceBefore.Size = new System.Drawing.Size(320, 240);
		FaceBefore.Location = new Point(320, 0);
		FaceBefore.Image = picture.testImage.ToBitmap();
		FaceBefore.Size = new System.Drawing.Size(320, 240);
	...
	private void tab1Button1_Click(object sender, System.EventArgs e)
	{
		...
		FaceBefore.Image = tmpImg.ToBitmap();
		FaceBefore.Size = new System.Drawing.Size(640, 480);
		FaceAfter.Image = tmpImg.ToBitmap();
		FaceAfter.Size = new System.Drawing.Size(640, 480);
